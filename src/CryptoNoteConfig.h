...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 980789;
...
const uint64_t MONEY_SUPPLY                                   = UINT64_C(106744073709551615);
...
const uint64_t GENESIS_BLOCK_REWARD                           = UINT64_C(10674407370955162);
...
const char     CRYPTONOTE_NAME[]                             = "hashratecoin";
...
const int      P2P_DEFAULT_PORT                              =  22997;
const int      RPC_DEFAULT_PORT                              =  22998;
...
const char* const SEED_NODES[] = { "206.81.12.30:22997", "139.59.151.195:22997" };
